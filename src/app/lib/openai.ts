...
function getOpenAIClient() {
    ...
    if (!OPENAI_API_KEY) {
        // During build time, we don't want to throw an error immediately at the top level.
        // We only throw if something actually tries to use the client without a key.
