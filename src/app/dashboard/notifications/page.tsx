...
const NotificationsPage = () => {
  const convexNotifications = useNotifications();
  const notifications: NotificationData[] = (convexNotifications ?? []) as NotificationData[];
  ...
  return (
    <PageContainer title="Notifications" description="View all notifications">
      ...
      <Box sx={{ p: 3 }}>
        ...
        >
          <FullNotifications notifications={notifications.slice(0, 10)} loading={loading} error={error} />
        </Paper>
      </Box>
    </PageContainer>
  );
